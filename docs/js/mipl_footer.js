...
<!-- start bottom credits -->

//document.write('<script id="_fed_an_ua_tag" type="text/javascript" src="https://dap.digitalgov.gov/Universal-Federated-Analytics-Min.js?agency=NASA&subagency=JPL&dclink=true&sp=search,s,q&sdor=false&exts=tif,tiff"></script>');

//document.write('<div id="footer">');
//document.write('   <div class="usa_gov"><a href="http://www.usa.gov/ " target="_blank"><img src="logousadotgov.gif" width="128" height="41" alt="www.USA.gov"></a>');
//document.write('    </div>');
